...
syn region matlabBlockBB			start="\<if\>" end="\<end\>" fold transparent contains=ALL
syn region matlabBlockBB			start="\<for\>" end="\<end\>" fold transparent contains=ALL
syn region matlabBlockBB			start="\<function\>" end="\<end\>" fold transparent contains=ALL
